...
$updatequery="UPDATE score_board  JOIN players ON score_board.player_id = players.id SET score_board.score ='$newscore',score_board.coins ='$coins',players.health  ='$health',players.time  ='$time',players.level_id ='$level',players.the_level  ='$the_level' WHERE players.username='".$username."';";
